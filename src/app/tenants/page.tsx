...
export default function TenantsPage() {
  ...
  const query = useQuery({
    ...
    queryFn: () =>
      apiRequest<PaginatedTenants>(
        `/tenants?page=${page}&limit=20&sort=createdAt:desc${search ? `&search=${encodeURIComponent(search)}` : ""}${status ? `&status=${status}` : ""}`,
      ),
  });
  ...
  function submit(event: FormEvent) {
    ...
    if (name.trim() && slug) create.mutate();
  }
  return (
    <AppShell>
      <PlatformGate>
        <div className="space-y-6">
          <PageHeader
            title="Tenants"
            description="Manage clinic organizations using the platform."
            actions={
            ...
            <CardContent className="p-0">
              ...
              {query.isLoading ? (
                ...
                <EmptyState
                  ...
                  description="Add a clinic organization or adjust your search filters."
                  action={
                    <Button onClick={() => setOpen(true)}>
                      <Plus />
                      Add Tenant
                      ...
                      <tbody>
                        {query.data.data.map((tenant) => (
                          ...
                          >
                            ...
                            <td className="px-4 py-3">{tenant.memberCount}</td>
                            <td className="px-4 py-3 text-muted-foreground">
                ...
                <form onSubmit={submit} className="mt-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Lowercase letters, numbers, and hyphens only. The slug is
